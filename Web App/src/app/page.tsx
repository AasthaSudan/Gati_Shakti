      ...
      <section className="py-16 bg-gradient-to-br from-slate-900 to-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Access different modules of the Rail Kavach system for monitoring, communication, and management.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <Link href="/dashboard">
                <Card className="bg-slate-800 border-slate-700 h-full hover:bg-slate-750 transition-colors cursor-pointer group">
                  <CardHeader className="text-center pb-2">
                    <div className="p-4 w-16 h-16 rounded-full bg-blue-900/50 flex items-center justify-center mx-auto mb-4 group-hover:bg-blue-900/70 transition-colors">
                      <Gauge className="h-8 w-8 text-blue-400" />
                    </div>
                    <CardTitle className="text-white text-xl">Control Dashboard</CardTitle>
                    <CardDescription className="text-gray-400">
            ...
            >
              <Link href="/chat">
                <Card className="bg-slate-800 border-slate-700 h-full hover:bg-slate-750 transition-colors cursor-pointer group">
                  <CardHeader className="text-center pb-2">
                    <div className="p-4 w-16 h-16 rounded-full bg-green-900/50 flex items-center justify-center mx-auto mb-4 group-hover:bg-green-900/70 transition-colors">
                      <MessageCircle className="h-8 w-8 text-green-400" />
                    </div>
                    <CardTitle className="text-white text-xl">Communication Hub</CardTitle>
                    <CardDescription className="text-gray-400">
                      Chat between train drivers and station admins
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="text-center">
            ...
            >
              <Link href="/detection">
                <Card className="bg-slate-800 border-slate-700 h-full hover:bg-slate-750 transition-colors cursor-pointer group">
                  <CardHeader className="text-center pb-2">
                    <div className="p-4 w-16 h-16 rounded-full bg-purple-900/50 flex items-center justify-center mx-auto mb-4 group-hover:bg-purple-900/70 transition-colors">
                      <Camera className="h-8 w-8 text-purple-400" />
                    </div>
                    <CardTitle className="text-white text-xl">Animal Detection</CardTitle>
                    <CardDescription className="text-gray-400">
                      AI-powered detection system monitoring
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="text-center">
            ...
            >
              <Link href="/trains">
                <Card className="bg-slate-800 border-slate-700 h-full hover:bg-slate-750 transition-colors cursor-pointer group">
                  <CardHeader className="text-center pb-2">
                    <div className="p-4 w-16 h-16 rounded-full bg-yellow-900/50 flex items-center justify-center mx-auto mb-4 group-hover:bg-yellow-900/70 transition-colors">
                      <Badge className="h-8 w-8 text-yellow-400" />
                    </div>
                    <CardTitle className="text-white text-xl">Train Tracker</CardTitle>
                    <CardDescription className="text-gray-400">
                      Live train tracking and status updates
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="text-center">
                    <Button variant="outline" className="w-full border-yellow-500 text-yellow-400 hover:bg-yellow-500 hover:text-white">
                      Track Trains
                    </Button>
                  </CardContent>
                </Card>
